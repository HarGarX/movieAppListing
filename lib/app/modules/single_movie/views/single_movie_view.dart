  ...
  Widget build(BuildContext context) {
    ...
    return OrientationBuilder(builder: (context, orientation) {
      return MediaQuery.of(context).orientation == Orientation.portrait
          ? PortraitMode(releaseDateFormat: releaseDateFormat)
          : LandscapeMode(releaseDateFormat: releaseDateFormat);
    });
...
class PortraitMode extends StatelessWidget {
  const PortraitMode({
    Key? key,
    required this.releaseDateFormat,
  }) : super(key: key);
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        ElevatedButton(
                          style: ButtonStyle(
                            fixedSize:
                                MaterialStateProperty.all(Size(45.0.w, 50)),
                            shape: MaterialStateProperty.all<
                                    RoundedRectangleBorder>(
                                RoundedRectangleBorder(
                                    borderRadius: BorderRadius.circular(12.0),
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: ListView.builder(
                        scrollDirection: Axis.horizontal,
                        itemCount:
                            singleMovieController.movieModel.genreIds.length,
                        itemBuilder: (context, index) {
                          return Container(
                            // width: 100.0,
                            padding: EdgeInsets.all(10.5),
